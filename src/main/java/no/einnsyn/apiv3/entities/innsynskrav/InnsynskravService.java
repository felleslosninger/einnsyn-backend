...
public class InnsynskravService extends EinnsynObjectService<Innsynskrav, InnsynskravJSON> {
  ...
  @Resource private BrukerService brukerService;
  ...
  @Getter private InnsynskravService service = this;
  ...
  @Override
  public Innsynskrav fromJSON(
      InnsynskravJSON json, Innsynskrav innsynskrav, Set<String> paths, String currentPath) {
      ...
      innsynskravDelListField.forEach(
          innsynskravDelField -> {
            ...
            InnsynskravDel innsynskravDel =
                innsynskravDelService.fromJSON(
                    innsynskravDelField.getExpandedObject(), paths, path);
  ...
  @Override
  public InnsynskravJSON toJSON(
      Innsynskrav innsynskrav, InnsynskravJSON json, Set<String> expandPaths, String currentPath) {
