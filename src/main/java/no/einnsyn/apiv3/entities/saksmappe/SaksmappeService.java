...
public class SaksmappeService extends MappeService<Saksmappe, SaksmappeJSON> {
  ...
  @Getter private SaksmappeService service = this;
   ...
   */
  @Override
  public Saksmappe fromJSON(
      SaksmappeJSON json, Saksmappe saksmappe, Set<String> paths, String currentPath) {
   ...
   */
  @Override
  public SaksmappeJSON toJSON(
      Saksmappe saksmappe, SaksmappeJSON json, Set<String> expandPaths, String currentPath) {
