...
public class KorrespondanseparttypeResolver {
  ...
  public static final String BASE = "http://www.arkivverket.no/standarder/noark5/arkivstruktur/";
  ...
  private static final Pattern PAT_GRUPPEMOTTAKER =
      Pattern.compile("(" + BASE + ")?gruppemottaker");
  private static final Pattern PAT_INTERN_AVSENDER =
      Pattern.compile("(" + BASE + ")?intern_?[Aa]vsender");
  private static final Pattern PAT_INTERN_MOTTAKER =
      Pattern.compile("(" + BASE + ")?intern_?[Mm]ottaker");
