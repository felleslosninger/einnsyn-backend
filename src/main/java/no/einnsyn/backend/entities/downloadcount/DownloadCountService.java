...
public class DownloadCountService extends BaseService<DownloadCount, DownloadCountDTO> {
   ...
   * attributed to. Files attached to a Moetedokument are attributed to the Moetemappe:
   * Moetedokument is a Registrering, but it is not indexed in Elasticsearch on its own, its
   * metadata is added to the Moetemappe document instead.
   *
