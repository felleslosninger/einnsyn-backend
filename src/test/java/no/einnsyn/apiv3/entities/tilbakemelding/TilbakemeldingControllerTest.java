...
class TilbakemeldingControllerTest extends EinnsynControllerTestBase {
  ...
  void insertTilbakemelding() throws Exception {
    ...
    assertEquals(tilbakemeldingJSON.get("userSatisfied"), insertedTilbakemeldingJSON.getUserSatisfied());
    assertEquals(tilbakemeldingJSON.get("handledByAdmin"), insertedTilbakemeldingJSON.getHandledByAdmin());
    assertEquals(tilbakemeldingJSON.get("adminComment"), insertedTilbakemeldingJSON.getAdminComment());
    ...
    assertEquals(HttpStatus.OK, tilbakemeldingResponse.getStatusCode());
    insertedTilbakemeldingJSON = gson.fromJson(tilbakemeldingResponse.getBody(), TilbakemeldingJSON.class);
    assertEquals(tilbakemeldingJSON.get("messageFromUser"), insertedTilbakemeldingJSON.getMessageFromUser());
